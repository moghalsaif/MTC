  ...
  return (
    <div className="min-h-screen bg-[#1B1B1B] noise-bg flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="bg-[#27272A] border border-[#3F3F46] rounded-sm p-8">
          <h1 className="font-heading text-4xl font-black text-white tracking-tight mb-2" data-testid="login-title">
            FLIGHT DECK
          </h1>
          <p className="text-[#A1A1AA] text-sm mb-8">Equipment Tracker Dashboard</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              ...
              disabled={loading}
              className="w-full bg-[#F9982E] hover:bg-[#F9982E]/90 text-black font-bold uppercase tracking-wider rounded-sm h-12"
            >
